...
function(t, i) {
    ...
    ***************************************************************************** */
    ...
    function i(i, e) {
        ...
        t(i, e),
        i.prototype = null === e ? Object.create(e) : (s.prototype = e.prototype, new s)
    }
    var e = function() {
        return (e = Object.assign ||
        function(t) {
            for (var i, e = 1,
            s = arguments.length; e < s; e++) for (var r in i = arguments[e]) Object.prototype.hasOwnProperty.call(i, r) && (t[r] = i[r]);
            return t
    ...
    function s(t, i, e, s) {
        ...
        else for (var h = t.length - 1; h >= 0; h--)(r = t[h]) && (o = (n < 3 ? r(o) : n > 3 ? r(i, e, o) : r(i, e)) || o);
        return n > 3 && o && Object.defineProperty(i, e, o),
        o
    }
    function r() {
        for (var t = 0,
        i = 0,
        e = arguments.length; i < e; i++) t += arguments[i].length;
        var s = Array(t),
        r = 0;
        for (i = 0; i < e; i++) for (var n = arguments[i], o = 0, h = n.length; o < h; o++, r++) s[r] = n[o];
        return s
    }
    try {
        Object.entries || (Object.entries = function(t) {
            for (var i = Object.keys(t), e = i.length, s = new Array(e); e--;) s[e] = [i[e], t[i[e]]];
            return s
        }),
    ...
    h = function(t) {
        return function(t) {
            for (var i, e, s, r, o = "",
            h = 0,
            a = (t = String(t)).length % 3; h < t.length;) {
    ...
    a = function(t) {
        return decodeURIComponent(function(t) {
            ...
            for (var i, e, s, r = "",
            h = 0; h < t.length;) i = n.indexOf(t.charAt(h++)) << 18 | n.indexOf(t.charAt(h++)) << 12 | (e = n.indexOf(t.charAt(h++))) << 6 | (s = n.indexOf(t.charAt(h++))),
            r += 64 === e ? String.fromCharCode(i >> 16 & 255) : 64 === s ? String.fromCharCode(i >> 16 & 255, i >> 8 & 255) : String.fromCharCode(i >> 16 & 255, i >> 8 & 255, 255 & i);
            return r
    ...
    l = function(t, i) {
        ...
        return function() {
            for (var r = arguments,
            n = [], o = 0; o < arguments.length; o++) n[o] = r[o];
    ...
    v = function() {
        ...
        return 0 === i.length ? {}: i.length < 2 ? i[0] : i.reduce((function(t, i) {
            if (!d(t) || !d(i)) return console.error("deepMerge arguments only access object"),
            t;
            var e = t || {};
            return Object.entries(i).forEach((function(i) {
                var s = i[0],
                n = i[1];
                if (void 0 !== n) if (t[s]) if (f(t[s])) {
    ...
    y = function(t) {
        var i, e, s = t.replace(/^v/, "").replace(/\+.*$/, ""),
        r = (e = "-", -1 === (i = s).indexOf(e) ? i.length: i.indexOf(e)),
        n = s.substring(0, r).split(".");
        return n.push(s.substring(r + 1)),
        n
    },
    k = function(t, i) { [t, i].forEach(m);
    ...
    var U = function() {
                ...
                return t.queue = new b({
                    request: function(s) {
                        ...
                        t.request(r, {
                            ...
                            return console.error("APICaller error", t),
                            "request:fail url not in domain list" === t.msg ? e(e({},
                            t), {
                                success: !0
                            }) : t
                        }))
        ...
        t.prototype.track = function(t, i) {
            ...
            return e && console && "function" == typeof console.log && console.log("\u3010Track\u3011 " + t, s),
            this.queue.add({
                type: t,
                props: s
            }),
        ...
        t.prototype.setContext = function(t) {
            return console.warn("setContext \u4e0d\u5728\u63a8\u8350\u4f7f\u7528\uff0c\u8bf7\u7528\u66f4\u8f7b\u4fbf\u7684 setUser\u3001setChan\u7b49\u65b9\u6cd5\u4ee3\u66ff"),
            this.context = e(e(e({},
            this.context), t), {
                wx_user: e(e({},
                this.context.wx_user), t.wx_user || {}),
                chan: e(e({},
                this.context.chan), t.chan || {})
            }),
            this
        },
        ...
        t.prototype.clearComponent = function() {
            return delete this.context.component,
            this
        },
        ...
        t.prototype.clearActivityInfo = function() {
            return delete this.context.activity_info,
            this
        },
        t.prototype.startReport = function() {
            return this.reportState = C.REPORTING,
            this.triggerFlush(),
            this
        },
        ...
        t.prototype.pauseReport = function() {
            return this.reportState = C.PAUSED,
            this.setCache(A.TRACKS, this.queue.clean()),
            this
        },
        t.prototype.flush = function() {
            return this.queue.flush(this.context),
            this
        },
        t.prototype.onQueue = function(t) {
            return this._onQueue = t,
            this
        },
        ...
        t.prototype.checkStaticMethods = function() {
            if ("development" === this.env) try {
                var t = this.constructor; ["create"].forEach((function(i) { ! t[i] && console.error("static " + i + " should be implement")
                }))
            } catch(t) {
        ...
        t.prototype.setCache = function(t, i) {
            ...
            var r = e(e({},
            this.cacheManager.get(A.SDK) || {}), ((s = {})[t] = i, s));
            this.cacheManager.set(A.SDK, r)
        },
        t.prototype.getServerUrl = function() {
            var t = "";
            return t = "function" == typeof this.option.serverUrl ? this.option.serverUrl.call(this) : this.option.serverUrl || "https://zhls.qq.com/api/report",
    ...
    function R(t, i, e, s) {
        ...
        t[i] = function() {
            for (var t = arguments,
            i = this,
            o = [], h = 0; h < arguments.length; h++) o[h] = t[h];
            var a = function() {
    ...
    var F = function() {
        ...
        return t.AddUnsigned = function(t, i) {
            ...
            (e = 1073741824 & t) & (s = 1073741824 & i) ? 2147483648 ^ o ^ r ^ n: e | s ? 1073741824 & o ? 3221225472 ^ o ^ r ^ n: 1073741824 ^ o ^ r ^ n: o ^ r ^ n
        },
        t.FF = function(t, i, e, s, r, n, o) {
            return t = this.AddUnsigned(t, this.AddUnsigned(this.AddUnsigned(this.F(i, e, s), r), o)),
            this.AddUnsigned(this.RotateLeft(t, n), i)
        },
        t.GG = function(t, i, e, s, r, n, o) {
            return t = this.AddUnsigned(t, this.AddUnsigned(this.AddUnsigned(this.G(i, e, s), r), o)),
            this.AddUnsigned(this.RotateLeft(t, n), i)
        },
        t.HH = function(t, i, e, s, r, n, o) {
            return t = this.AddUnsigned(t, this.AddUnsigned(this.AddUnsigned(this.H(i, e, s), r), o)),
            this.AddUnsigned(this.RotateLeft(t, n), i)
        },
        t.II = function(t, i, e, s, r, n, o) {
            return t = this.AddUnsigned(t, this.AddUnsigned(this.AddUnsigned(this.I(i, e, s), r), o)),
            this.AddUnsigned(this.RotateLeft(t, n), i)
        },
        t.ConvertToWordArray = function(t) {
            for (var i, e = t.length,
            s = e + 8,
            r = 16 * ((s - s % 64) / 64 + 1), n = Array(r - 1), o = 0, h = 0; h < e;) o = h % 4 * 8,
        ...
        t.init = function(t) {
            for ("string" != typeof t && (t = JSON.stringify(t)), this._string = this.Utf8Encode(t), this.x = this.ConvertToWordArray(this._string), this.a = 1732584193, this.b = 4023233417, this.c = 2562383102, this.d = 271733878, this.k = 0; this.k < this.x.length; this.k += 16) this.AA = this.a,
            this.BB = this.b,
            this.CC = this.c,
            this.DD = this.d,
            ...
            return function(t, i, e, s, r) {
                if (R(t, "onLoad", (function(t, i) {
                    ...
                    if (t.onShareAppMessage = function(t) {
                        ...
                        var e = n.call(this, t) || {};
                        try {
                            var s = e.path || D.call(this, "share"); - 1 === s.indexOf("?") ? s += "?": "&" !== s.slice( - 1) && (s += "&");
                            var o = void 0,
                            h = void 0;
                            r && (o = q(), h = JSON.parse(o), s = s + "txsrShareInfoSdk=" + encodeURIComponent(o)),
                    ...
                    "function" == typeof t.onShareTimeline) {
                        ...
                        t.onShareTimeline = function(t) {
                            ...
                            try {
                                ...
                                n = e.query || ""; - 1 === s.indexOf("?") ? s += "?": "&" !== s.slice( - 1) && (s += "&");
                                var h = void 0,
                                a = void 0;
                                r && (h = q(), a = JSON.parse(h), s = s + "txsrShareInfoSdk=" + encodeURIComponent(h)),
                                i("page_share_app_message", {
                                    is_sdk_auto_track: !0,
                                    from_type: t.from || "\u672a\u77e5",
                                    share_to: "timeline",
                ...
                return s && Object.entries(t).filter((function(t) {
                    ...
                    "function" == typeof e[1] && R(t, s, (function(t) {
                        for (var e = arguments,
                        r = [], n = 1; n < arguments.length; n++) r[n - 1] = e[n];
                        return M.call(this, r, i, s),
                        t()
                    }))
                })),
                t
        ...
        return function(r) {
            return function(t, i, e, s, r) {
                try {
                    ...
                    R(t.methods, "onLoad", (function(t, i) {
                        t(),
                        this.lauchTime = Q()
    ...
    Y = function(t) {
        function s() {
            ...
            i.request = function(t, e) {
                ...
                return "function" == typeof i.option.onUploaded && (s = i.option.onUploaded),
        ...
        s.prototype.getFrameworkInfo = function() {
            var t, i;
            try {
                if (process && process.env && process.env.TARO_ENV && (t = "taro"), this.option.installFrom) {
        ...
        s.prototype.getPageInfo = function() {
            ...
            try {
                void 0 === s && t && !$[t] && ($[t] = !0, console.warn("\u9875\u9762[" + t + "]\u6ca1\u6709\u5b9e\u73b0 title \u5c5e\u6027\uff0c\u4f1a\u5bfc\u81f4\u90e8\u5206\u673a\u578b\u4e0b\u6536\u96c6\u4e0d\u5230\u9875\u9762\u6807\u9898!")),
                "string" == typeof s && (e = function() {
                    return s
                }),
        ...
        s.create = function() {
            ...
            try {
                ...
                t = s.prototype,
                console.error("new sr_sdk failed", i)
            }
            return t
        },
        s
