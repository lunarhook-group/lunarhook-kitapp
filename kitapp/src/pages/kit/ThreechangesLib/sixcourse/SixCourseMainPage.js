...
import {StyleSheet,View, Text,Button,TouchableOpacity,FlatList,ScrollView,CameraRoll} from 'react-native';
            ...
            <WhiteSpace size="xl" />
                          ...
                          <TabNavigator tabBarStyle={[{height:ScreenConfig.getTabBarHeight()}]}>
                            <TabNavigator.Item
                                  ...
                                  onPress={() => {this.setState({shareimg:true}),WechatShare.snapshot(this.refs['location'], "六壬四课",this)}}
