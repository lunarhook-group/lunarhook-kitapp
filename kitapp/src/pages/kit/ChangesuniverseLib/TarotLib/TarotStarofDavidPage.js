...
class TarotStarofDavidPage extends React.Component {
  ...
  static navigationOptions = ({ navigation }) => {
    ...
    return {
      /*
      headerRight:
      ('off'==navigation.getParam( 'TarotState', 'off' )?'':
        <Button icon={{name:'refresh',size: 20,color: '#900'}} title='清除' color='#000' fontSize={15} onPress={()=> TarotStarofDavidPage_controllor.clear()}
          buttonStyle={{
